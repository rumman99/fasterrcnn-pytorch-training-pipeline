...
fasterrcnn_resnet50_fpn_v2 - Custom 2
1) Added batchnormalization to the RPN block
====================================================================================================
Total params: 43,662,052
Trainable params: 43,436,708
Non-trainable params: 225,344
Total mult-adds (T): 1.12
====================================================================================================
Input size (MB): 19.66
Forward/backward pass size (MB): 15842.35
Params size (MB): 174.65
Estimated Total Size (MB): 16036.66
====================================================================================================
...
def create_model(num_classes, pretrained=True, coco_model=False):
    ...
    model.rpn.head.conv[0] = RegionProposalNetwork(256, 256)
    model.rpn.head.conv[1] = RegionProposalNetwork(256, 256)
